...
function myFunction() {document.querySelector("#dframe").setAttribute("src","https://download.ytmp3.su/api/widgetv2?key=a0d0d2393d1b413e32a5fc26b0065492c4634b87&url=" + document.getElementById("myText").value); document.querySelector("#dframe").classList.add("rfr");}
